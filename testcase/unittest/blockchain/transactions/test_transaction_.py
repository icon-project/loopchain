...
class TestTransactions:
    def test_type_is_none(self, tx_factory, tx_version):
        tx: Transaction = tx_factory(tx_version=tx_version)

        assert not tx.type()

    def test_size_attribute_has_set_correctly(self, tx_factory, tx_version):
    ...
    def test_is_signed(self, tx_factory, tx_version):
        tx: Transaction = tx_factory(tx_version=tx_version)
    ...
    def test_signer_address(self, tx_factory, tx_version):
        tx: Transaction = tx_factory(tx_version=tx_version)
