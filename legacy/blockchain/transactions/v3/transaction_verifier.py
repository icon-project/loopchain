...
from legacy.blockchain.exception import TransactionInvalidNidError
from legacy.blockchain.transactions import TransactionVerifier as BaseTransactionVerifier
from legacy.blockchain.transactions.v3 import TransactionSerializer, HASH_SALT

if TYPE_CHECKING:
    from legacy.blockchain.transactions import Transaction
