...
from legacy.jsonrpc.exception import GenericJsonRpcServerError
from legacy.blockchain.blocks import BlockBuilder, BlockVerifier as BaseBlockVerifier
from legacy.blockchain.blocks.v0_1a import BlockHeader
from legacy.blockchain.exception import ScoreInvokeError, ScoreInvokeResultError

if TYPE_CHECKING:
    from legacy.blockchain.types import ExternalAddress
    from legacy.blockchain.blocks import Block
    from legacy.blockchain.blocks.v0_1a import BlockBody
