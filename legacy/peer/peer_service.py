...
from legacy.baseservice import CommonSubprocess, ObjectManager, RestService
from legacy.crypto.signature import Signer
from legacy.peer import PeerInnerService, PeerOuterService
...
class PeerService:
    ...
    def _init_kms_helper(self, agent_pin):
        if self._get_use_kms():
            from legacy.tools.kms_helper import KmsHelper
