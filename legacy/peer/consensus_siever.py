...
from legacy.baseservice import ObjectManager, TimerService, SlotTimer, Timer
from legacy.blockchain.blocks import Block
from legacy.blockchain.exception import NotEnoughVotes, ThereIsNoCandidateBlock, InvalidBlock, ConsensusChanged
from legacy.blockchain.types import ExternalAddress, Hash32
from legacy.blockchain.votes import Votes
from legacy.channel.channel_property import ChannelProperty
from legacy.peer.consensus_base import ConsensusBase

if TYPE_CHECKING:
    from legacy.blockchain import BlockBuilder
...
class ConsensusSiever(ConsensusBase):
    ...
    async def consensus(self):
        ...
        async with self.__lock:
            ...
            next_height = candidate_block.header.height + 1
