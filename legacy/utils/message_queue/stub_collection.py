...
if TYPE_CHECKING:
    from legacy.peer import PeerInnerStub
    from legacy.channel.channel_inner_service import ChannelInnerStub, \
        ChannelTxReceiverInnerStub, ChannelTxCreatorInnerStub
    from legacy.scoreservice import ScoreInnerStub, IconScoreInnerStub
...
class StubCollection(metaclass=SingletonMetaClass):
    ...
    async def create_channel_tx_creator_stub(self, channel_name):
        from legacy import configure as conf
        from legacy.channel.channel_inner_service import ChannelTxCreatorInnerStub
    ...
    async def create_channel_tx_receiver_stub(self, channel_name):
        from legacy import configure as conf
        from legacy.channel.channel_inner_service import ChannelTxReceiverInnerStub
    ...
    async def create_score_stub(self, channel_name, score_package_name):
        from legacy import configure as conf
        from legacy.scoreservice import ScoreInnerStub
    ...
    async def create_icon_score_stub(self, channel_name):
        from legacy import configure as conf
        from legacy.scoreservice import IconScoreInnerStub
