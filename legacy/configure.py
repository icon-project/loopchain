...
import legacy
from legacy.components.singleton import SingletonMetaClass
from legacy.configure_default import *
...
class Configure(metaclass=SingletonMetaClass):
    ...
    def init_configure(self):
        ...
        self.__configure_info_list = {}
        self.__load_configure(legacy.configure_default, use_env=True)
