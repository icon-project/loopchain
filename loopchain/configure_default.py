...
DOS_GUARD_TX_COUNT_TO_START_REJECT = 20  # Maximum allowed size of unconfirmed tx pools.
DOS_GUARD_TX_COUNT_TO_RESUME_ACCEPT = 10
DOS_GUARD_TX_FROM_CHECK_BOUNDARY_TIME = 5
DOS_GUARD_THRESHOLD = 100
DOS_GUARD_TX_FROM_BLACKLIST_TIME = 120
