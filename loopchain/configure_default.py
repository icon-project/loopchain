...
# TIMEOUT_FOR_LEADER_COMPLAIN = INTERVAL_BLOCKGENERATION * 5  # 5 is test value for developing leader complain
TIMEOUT_FOR_LEADER_COMPLAIN = INTERVAL_BLOCKGENERATION * 10  # 10 is default for product
